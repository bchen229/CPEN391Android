...
public class ViewImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
//        Log.d("Click", ((PanoramioItem) i.getParcelableExtra(ImageManager.PANORAMIO_ITEM_EXTRA)).getThumbUrl());
        mItem = i.getParcelableExtra(ImageManager.PANORAMIO_ITEM_EXTRA);
        Log.d("Click", mItem.getThumbUrl());
...
//                        mOwner.setText(mItem.getOwner());
                ...
                Log.d("BLAH", e.getClass().toString());
